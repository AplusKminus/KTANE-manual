...
\begin{table}[h]
  ...
  \begin{tabular}{|
    ...
    \vspace{0cm}
    \includegraphics[height=0.8cm]{modules/0_explanation/ew_dvi-d} &
    \vspace{0cm}
    \includegraphics[height=0.8cm]{modules/0_explanation/ew_parallel} &
    \vspace{0cm}
    \includegraphics[height=0.8cm]{modules/0_explanation/ew_serial} \\ \hline
