...
}
{
  ...
  \begin{itemize}
    \item[$\bullet$] Press the correct button to progress the module to the next stage.
    Complete all stages A-E to disarm the module.
    \item[$\bullet$] Pressing an incorrect button will reset the module back to stage A and record a strike.
    \item[$\bullet$] Button positions are ordered from left to right.
  \end{itemize}
